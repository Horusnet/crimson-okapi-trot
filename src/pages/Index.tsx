  ...
  return (
    <div className="min-h-screen bg-black text-zinc-50">
      ...
      <main className="relative z-10">
        {/* Hero, Cómo funciona... (sin cambios) */}

        {/* (Omitido aquí por brevedad: resto del componente es igual al que ya tienes,
            solo cambia la tarjeta Horus Network abajo, que ahora usa horusServers) */}
        ...
        <section id="seguridad" className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          ...
          <div className="mt-4 grid gap-4 lg:grid-cols-3 lg:items-stretch">
            {/* ... carta grande de seguridad (sin cambios) ... */}
        ...
        {/* Resto de secciones (planes, privados, juegos, FAQ, CTA final) igual que antes */}
      </main>
    </div>
  );
};
